...
/*******************************************************************
 * 
 * Class FreqCounter reads words from user input and prints
 * the most frequently occurring word in the input. The minlen
 * tells the minimum words size of the words that is counted.
 * 
 * Example execution with RedBlackBinarySearchTree:
 * ------------------------------------
 * Size of the RedBlack Table: 9944
 * Time: 0.466866456 seconds.
 * Word: 'the', Frequency: 8230
 * ------------------------------------
 * 
 * Example execution with BinarySearchTree:
 * ------------------------------------
 * Size of the Search ST/Tree: 9945
 * Time: 0.01269099 seconds.
 * Word: 'the', Frequency: 8230
 * ------------------------------------
 * 
...
public class Four_FreqCounter {
	private Four_FreqCounter() { }
	...
	public static void main(String[] args) {
		...
		Four_RedBlackBinarySearchTree<String, Integer> st = new Four_RedBlackBinarySearchTree<String, Integer>();
		...
		System.out.println();
		System.out.println("Size of the RedBlack Table: " + st.size());
