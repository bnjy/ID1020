 ...
 * 
 * This is the lab task 'Problem 3' of Lab 2 in course ID1020 at KTH.
 * 
 * Algorithm Selection sort, that sorts an integer array in ascending order from user input,
 * and counts the number of swaps done.
 * 
 * Example execution:
 * 
 * array = {6,9,17,0,4}
...
public class NumberOfSwaps {
	...
	public static void sort(int[] array) {
		...
		StdOut.println("The total number of swaps: " + swap);
		StdOut.println();
	}
